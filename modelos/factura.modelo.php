...
class ModeloFacturas
{
    ...
    public static function mdlEditarFactura($tabla, $datos)
    {
        $stmt = Conexion::conectar()->prepare(
            "UPDATE $tabla 
         SET fecha_emision = :fecha_emision, bank = :bank, titular = :titular, account_number = :account_number, 
             account_type = :account_type, monto = :monto, status_factura = :status_factura, fecha_limite = :fecha_limite
