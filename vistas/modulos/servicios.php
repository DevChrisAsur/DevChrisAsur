            ...
            <div class="box-body">
                ...
                <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
                    ...
                    <tbody>
                        ...
                        $item = null;
                        $valor = null;
                        $clientes = ControladorServicios::ctrVerServicios($item, $valor);
                ...
                <div class="modal-content">
                    <form role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="nuevoServicio" placeholder="Registrar Servicio">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input-lg" name="nuevoCostoServicio" placeholder="Costo del servicio">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-users"></i></span>
                                    <input type="number" class="form-control input-lg" name="numPersonesServicio" placeholder="Numero de personas cubiertas">
                                    </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="register" class="btn btn-primary">Registrar Servicio</button>
                        </div>
                        <?php
                        $crearServicio = new ControladorServicios();
                        $crearServicio->ctrCrearServicios();
                        ?>
                    </form>
                </div>
            </div>
