<style>
  ...
  .form-group {
    ...
    /* Cambia a row si quieres alinear en una fila */
    gap: 5px;
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control input-lg" id="editarNombre" name="editarNombre" placeholder="Actualizar Nombres">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-user"></i></span>
                      <input type="text" class="form-control input-lg" id="editarApellido" name="editarApellido" placeholder="Actualizar Apellidos">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <select class="form-control input-lg" id="reasignarCoordinador" name="reasignarCoordinador">
                            ...
                            echo '<option value="0">Sin coordinador</option>';
