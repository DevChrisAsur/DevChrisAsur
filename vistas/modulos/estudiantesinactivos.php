...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Administrar Estudiantes Inactivos
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <thead>
         ...
         <tr>
            ...
            <th style="width:100px">Fecha Nacimiento</th>
...
$estudiantes = ControladorEstudiantes::ctrMostrarEstudiantesInactivos($item, $valor);

foreach ($estudiantes as $key => $value) {
  echo '<tr>';
echo '<td>' . ($key + 1) . '</td>';
echo '<td>' . $value["retirement_date"] . '</td>';
echo '<td>' . $value["cc"] . '</td>';
...
echo '</div>';
echo '<button class="btn btn-primary btnCertificadoRetiro" idStudent="'.$value["id_student"].'" style="margin-left: 8px;"><i class="fa fa-file-pdf-o"></i></button>';
echo '</td>';
echo '</tr>';
}
...
// });
$(document).ready(function(){
    $('.btnCertificadoRetiro').click(function(){
        var idStudent = $(this).attr('idStudent');
       


          swal({
    title: '¿Está seguro de generar el certificado de retiro?',
    ...
    if(result.value){
      ...
      //window.location = "correos.php?ruta=usuarios&idUsuario="+idUsuario+"&usuario="+usuario+"&idUser="+idUser;
 window.location = 'certificado_retiro.php?idStudent='+idStudent;
