...
<head>
    ...
    <style>
        body {
            background-image: url('vistas/img/plantilla/Fondo.jpeg'); /* Background image from the uploaded file */
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="modal" data-bs-target="#imageModal">SERVICIOS</a>
                    </li>
                    <li class="nav-item">
