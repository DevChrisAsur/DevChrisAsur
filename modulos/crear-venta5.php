...
include("registrar_visitantes_es.php");
...
<div class="container">
  ...
  <form action="recibe_excel_validando_es.php" name="formulario" method="POST" enctype="multipart/form-data"/ onsubmit="return validateForm()" required>
