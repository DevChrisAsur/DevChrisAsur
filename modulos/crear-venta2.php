<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Nuevo Contratista</li>
...
<div class="container">
  ...
  <form action="recibe_excel_validando_contratistas.php" name="formulario" method="POST" enctype="multipart/form-data"/ onsubmit="return validateForm()" required>
...
<?php
include("registrar_contra.php");
include("contra_correos.php");
