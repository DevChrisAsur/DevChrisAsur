...
<div class="col-md-5">
                    ...
                    <br>
                     ...
                     <div class="input-group-prepend">
                         <button type="submit" name="filter" class="btn btn-success" style="margin: 4px 2px;width:70px; height:35px">Buscar</button>
                     &nbsp<button id="reset" class="btn btn-warning" style="margin: 4px 2px;width:70px; height:35px">Limpiar</button>
                </div>
                <div class="box-body">
        ...
        <thead>
         <tr>
          ...
          <th style="width:110px">Area</th>
           <th style="width:110px">Tipo Contrato</th>
              ...
              while ($row = $resultado -> fetch_array()) {
                ...
                $log = $row['ultimo_login'];
                 echo ' <tr>  
                    ...
                    if($Area != ""){
                      echo '<td><button class="btn btn-success btn-xs btnActivar text-uppercase" idUsuario="'.$Area.'" estadoUsuario="0">'.$Area.'</button></td>';
                    }else{
                      echo '<td><button class="btn btn-danger btn-xs btnActivar text-uppercase" idUsuario="'.$Area.'" estadoUsuario="0">REGISTRAR AREA</button></td>';
                    }
                    if($contrato == "Definido"){
                      echo '<td><button class="btn btn-success btn-xs btnActivar text-uppercase" idUsuario="'.$contrato.'" estadoUsuario="0">'.$contrato.'</button></td>';
                    }
                    elseif($contrato == "Indefinido"){
                      echo '<td><button class="btn btn-warning btn-xs btnActivar text-uppercase" idUsuario="'.$contrato.'" estadoUsuario="0">'.$contrato.'</button></td>';
                    }
                    else{
                      echo '<td><button class="btn btn-danger btn-xs btnActivar text-uppercase" idUsuario="'.$contrato.'" estadoUsuario="0">EDITAR TIPO DE CONTRATO</button></td>';
                    }
...
"dom": "<'row'<'col-sm-12 col-md-4'l><'col-sm-12 col-md-4'B><'col-sm-12 col-md-4'f>>" +
                    ...
                    "buttons": [
    {extend:"copy",title: "Reportes Usuarios",text:'<i class="fa fa-copy"></i>&nbsp;&nbsp;Copiar',titleAttr:"Copiar",className:"btn-warning"},
      {extend:"csv",title: "Reportes Usuarios ",text:'<i class="fa fa-file-o"></i>&nbsp;&nbsp;CSV',titleAttr:"Descargar CSV",className:"btn btn-info"},
      {extend:"excel",title: "Reportes Usuarios",text:'<i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;Excel',titleAttr:"Exportar a excel",className:"btn-success"},
      {extend:"pdf", title: "Reportes Usuarios", orientation: 'landscape', pageSize: 'A4',text:'<i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;PDF',titleAttr:"Exportar a PDF",className:"btn-danger"},
      {extend:"print",title: "Reportes Usuarios",text:'<i class="fa fa-print"></i>&nbsp;&nbsp; Imprimir',titleAttr:"Imprimir",className:"btn-primary"}
                    ],
                    "language": {
